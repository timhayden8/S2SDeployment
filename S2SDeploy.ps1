...
$gatewayIP = new-azpublicipaddress -name $vngcsv.publicipname -resourcegr0upname $vngcsv.resourcegroup -location $vngcsv.location -allocationmethod dynamic
...
$VirtualNetworkGateway=New-AzVirtualNetworkGateway -Name ($vnet+='VNG') -ResourceGroupName $vngcsv.resourcegroup -Location $vngcsv.location -IpConfigurations $gatewayipconfig -GatewayType Vpn -VpnType RouteBased -GatewaySku VpnGw1
